            ...
            <div className="wp-s4-pitch-wrap">
              <div className="wp-s4-pitch isometric-field">
                ...
                <div className="wp-zone wp-zone-top" style={{position:'relative'}}>
                  <div style={{position:'absolute',inset:0,background:clr,opacity:pct(tickerTotal)===0?0:0.2+(pct(tickerTotal)/100)*0.6}}/>
                ...
                <div className="wp-zone wp-zone-mid" style={{position:'relative'}}>
                  <div style={{position:'absolute',inset:0,background:'#3b82f6',opacity:pct(statsTotal)===0?0:0.2+(pct(statsTotal)/100)*0.6}}/>
                ...
                <div className="wp-zone wp-zone-bot" style={{position:'relative'}}>
                  <div style={{position:'absolute',inset:0,background:'#10b981',opacity:pct(lineupsTotal)===0?0:0.2+(pct(lineupsTotal)/100)*0.6}}/>
